...
for elements in range(1, number_of_ships + 1):
    ...
    print("Joueur numéro 1 le bateau que vous placez est le : {} avec une taille de : {}".format(bateau.ship_name,bateau.ship_size))
    coord_col = input("Joueur numéro 1, veuillez choisir une colonne comme point de départ pour placer le {} : ".format(bateau.ship_name)).upper()
    coord_row = int(input("Joueur numéro 1, veuillez choisir une ligne comme point de départ pour placer le {} : ".format(bateau.ship_name)))
    bateau.position_bateau(coord_col, coord_row,bateau, list_plateau1)
...
while game_finished == False:
    if tour_joueur == 0:
        ...
        choix_row_joueur1 = int(input("Joueur numéro 1 : {}, Veuillez introduire la ligne : ".format(joueur1.player_name)))
        ...
        plateau_joueur1.afficher_tableau(list_plateau1)
        choix_row_joueur2 = int(input("Joueur numéro 2 : {}, Veuillez introduire la ligne : ".format(joueur2.player_name)))
